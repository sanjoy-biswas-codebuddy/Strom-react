...
const StepCard: React.FC<CardProps> = ({
  ...
  return (
    <div
      className={`basis-full shadow-card border border-[#FCACAC] rounded-[12px] lg:p-8 p-4 text-center text-font-color bg-white transition-all duration-300 lg:text-left md:text-left  ${
        className || ""
      }`}
    >
      {image && (
